#!/usr/bin/env python3
"""
Convert paper_ndna_gpt2.md to publication-quality HTML with MathJax support.
...
MD_PATH = os.path.join(SCRIPT_DIR, "paper_ndna_gpt2.md")
HTML_PATH = os.path.join(SCRIPT_DIR, "paper_ndna_gpt2.html")
...
<title>Scaling Neural DNA to GPT-2: 354 Parameters Wire a Language Model</title>
...
def convert_title_block(html):
  ...
  <h1>Scaling Neural DNA to GPT-2: 354 Parameters Wire a Language Model</h1>
  ...
  <div class="contact">Model: <a href="https://huggingface.co/tejassuds/ndna-gpt2-small">huggingface.co/tejassuds/ndna-gpt2-small</a></div>
</div>
<hr class="title-sep" />
'''
