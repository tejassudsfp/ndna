#!/usr/bin/env node
/**
 * Generate PDF from paper_ndna_gpt2.html using Puppeteer.
...
const htmlPath = path.join(__dirname, 'paper_ndna_gpt2.html');
const pdfPath = path.join(__dirname, 'paper_ndna_gpt2.pdf');
